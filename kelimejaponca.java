 ...
 */
public class kelimejaponca extends javax.swing.JFrame {

    /**
     * Creates new form kelimejaponca
     */
    public kelimejaponca() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(kelimejaponca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new kelimejaponca().setVisible(true);
            }
        });
    }
